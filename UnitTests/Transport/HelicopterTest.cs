...
namespace UnitTests.Transport
{
    ...
    public class HelicopterTest
    {
        ...
        [Test]
        [TestCase(100, TestName = "Тестирование FuelConsumption при присваивании 100", ExpectedResult = 100)]
        [TestCase(200, TestName = "Тестирование FuelConsumption при присваивании 200", ExpectedResult = 200)]
        [TestCase(390, TestName = "Тестирование FuelConsumption при присваивании 390",
            ExpectedException = typeof(ArgumentException))]
        [TestCase(0, TestName = "Тестирование FuelConsumption при присваивании 0",
            ExpectedException = typeof(ArgumentException))]
        ...
        [Test]
        [TestCase(50, TestName = "Тестирование FuelConsumption при присваивании 50", ExpectedResult = 50)]
        [TestCase(80, TestName = "Тестирование FuelConsumption при присваивании 80", ExpectedResult = 80)]
        [TestCase(500, TestName = "Тестирование FuelConsumption при присваивании 500",
            ExpectedException = typeof(ArgumentException))]
        [TestCase(0, TestName = "Тестирование FuelConsumption при присваивании 0",
            ExpectedException = typeof(ArgumentException))]
        ...
        [Test]
        [TestCase(390, TestName = "Тестирование FuelConsumption при присваивании 390", ExpectedResult = 390)]
        [TestCase(400, TestName = "Тестирование FuelConsumption при присваивании 400", ExpectedResult = 400)]
        [TestCase(370, TestName = "Тестирование FuelConsumption при присваивании 370",
            ExpectedException = typeof(ArgumentException))]
        [TestCase(0, TestName = "Тестирование FuelConsumption при присваивании 0",
            ExpectedException = typeof(ArgumentException))]
        ...
        [Test]
        [TestCase(2000, 200, TestName = "Тестирвание метода GoTheDistance со значениями 100 и 2000",
            ExpectedResult = 10)]
        [TestCase(100, 150, TestName = "Тестирвание метода GoTheDistance со значениями 100 и 100",
            ExpectedResult = 150)]
        [TestCase(0, 20, TestName = "Тестирвание метода GoTheDistance со значениями 0 и 20",
            ExpectedException = typeof(ArgumentException))]
        [TestCase(-1, 0, TestName = "Тестирвание метода GoTheDistance со значениями -1 и 0",
            ExpectedException = typeof(ArgumentException))]
